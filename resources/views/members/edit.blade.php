    ...
    <section class="container login">
        <div class="row">
            ...
            <div class="col-lg-8 offset-lg-2">
                ...
                <h3 class="text-center mb-3 mb-lg-5 western">Modifier un membre</h3>
                    ...
                    <form method="post" action="{{ route('members.update', $member->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="mb-3 col-lg-6">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Ex: Hugo" value="{{ $member->name }}" required>
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <input type="text" class="form-control @error('alias') is-invalid @enderror" id="alias" name="alias" placeholder="Ex: Unlucky Luke" value="{{ $member->alias }}" required>
                        ...
                        <div class="row">
                            <div class="mb-3 col-lg-6">
                                ...
                                <input type="number" class="form-control @error('show_order') is-invalid @enderror" id="show_order" name="show_order" placeholder="Ex: 0" value="{{ $member->show_order }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <input type="file" class="form-control @error('bg') is-invalid @enderror" id="bg" name="bg" accept="image/png, image/jpeg, image/jpg">
                                <small><em>Formats acceptés : png, jpg, jpeg | Taille max : 2Mo</em></small>
                        ...
                        <div class="row">
                            <div class="mb-3 col">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description" placeholder="Résumer en quelques mots..." required>{{ $member->description }}</textarea>
